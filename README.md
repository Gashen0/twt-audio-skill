...
### 让 AI 做你的说书人：丢一条推文链接，AI 念给你听

**任何支持 MCP 的 AI 助手都能用 — Claude / Cursor / 小龙虾 / Cline**
...
> **刷到一条干货长推，眼睛酸了但还想看？**
> **通勤路上看到好内容，盯屏幕晕车？**
> **做饭、健身、睡前，想"听"推文而不是"看"推文？**

**twt-audio-mcp** 让你的 AI 助手多一个技能：把任何 Twitter/X 推文（包括长文 Article）转成 MP3 语音，念给你听。无需付费 API，全部免费。
...
| **📋 音频库** | 本地存储管理，list / send / delete |
| **🔄 自动去重** | 同一推文不会重复生成 |
| **🧩 MCP 协议** | 任何支持 MCP 的 AI 助手都能用 |
| **🖥️ CLI 模式** | 不用 MCP 也能命令行使用 |
